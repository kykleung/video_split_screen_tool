...
def process_and_combine_videos(left_video_path, left_start_time, right_video_path, right_start_time, output_path="combined_video.mp4"):
...
if __name__ == "__main__":
    ...
    process_and_combine_videos(args.left_video_path, args.left_start_time, args.right_video_path, args.right_start_time, args.output_path)
